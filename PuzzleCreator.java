...
public class PuzzleCreator {
    ...
    //prints pairmappings
    public static void printPairMappings(ArrayList<ArrayList<DomLoc>> pairMappings) {
    ...
    public static void createPuzzle(int n) {
        int width = n + 2;
        int height = n + 1;
    ...
    public static void matchSingletons(Coord coord) {
    ...
    public static Coord findSingleton() {
        for(int r = 0; r < grid.length; r++) {
            for(int c = 0; c < grid[r].length; c++) {
                if(grid[r][c] == 0) {
